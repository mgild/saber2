...
export declare class StableSwap {
     ...
     * @param fees
     */
    constructor(connection: Connection, stableSwap: PublicKey, swapProgramId: PublicKey, tokenProgramId: PublicKey, poolTokenMint: PublicKey, authority: PublicKey, adminAccount: PublicKey, adminFeeAccountA: PublicKey, adminFeeAccountB: PublicKey, tokenAccountA: PublicKey, tokenAccountB: PublicKey, mintA: PublicKey, mintB: PublicKey, initialAmpFactor: number, targetAmpFactor: number, startRampTimestamp: number, stopRampTimeStamp: number, fees?: Fees);
    /**
     ...
     */
    static loadStableSwap(connection: Connection, address: PublicKey, programId: PublicKey): Promise<StableSwap>;
    /**
     * Constructor for new StableSwap client object
     * @param connection
     * @param payer
     ...
     * @param fees
     */
    static createStableSwap(connection: Connection, payer: Account, stableSwapAccount: Account, authority: PublicKey, adminAccount: PublicKey, adminFeeAccountA: PublicKey, adminFeeAccountB: PublicKey, tokenMintA: PublicKey, tokenAccountA: PublicKey, tokenMintB: PublicKey, tokenAccountB: PublicKey, poolTokenMint: PublicKey, poolTokenAccount: PublicKey, mintA: PublicKey, mintB: PublicKey, swapProgramId: PublicKey, tokenProgramId: PublicKey, nonce: number, ampFactor: number, fees?: Fees): Promise<StableSwap>;
    /**
     ...
     */
    swap(userSource: PublicKey, poolSource: PublicKey, poolDestination: PublicKey, userDestination: PublicKey, amountIn: number, minimumAmountOut: number): Transaction;
    /**
     ...
     */
    deposit(userAccountA: PublicKey, userAccountB: PublicKey, poolTokenAccount: PublicKey, tokenAmountA: number, tokenAmountB: number, minimumPoolTokenAmount: number): Transaction;
    /**
     ...
     * @param minimumTokenB
     */
    withdraw(userAccountA: PublicKey, userAccountB: PublicKey, poolAccount: PublicKey, poolTokenAmount: number, minimumTokenA: number, minimumTokenB: number): Transaction;
}
